...
EXPECTED_TOOL_SIGNATURES: dict[str, list[str]] = {
    ...
    "delete_note": ["identifier", "is_directory", "project", "output_format"],
    ...
    "schema_diff": ["note_type", "project", "output_format"],
    "schema_infer": ["note_type", "threshold", "project", "output_format"],
    "schema_validate": ["note_type", "identifier", "project", "output_format"],
    "search": ["query"],
    "search_notes": [
        "query",
        "project",
