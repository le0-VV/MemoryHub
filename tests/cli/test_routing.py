...
class TestForceRouting:
    ...
    def test_local_flag_is_a_no_op(self):
        """Local flag should not mutate legacy routing env vars anymore."""
    ...
    def test_preserves_original_env_vars(self):
        """Should leave existing env var values untouched."""
    ...
    def test_restores_on_exception(self):
        """Should still leave env vars untouched when exception is raised."""
        os.environ.pop("BASIC_MEMORY_FORCE_LOCAL", None)
        os.environ.pop("BASIC_MEMORY_EXPLICIT_ROUTING", None)
