"""Repository dependency injection for memoryhub.
...
from memoryhub.deps.db import SessionMakerDep
...
from memoryhub.repository.search_repository import SearchRepository, create_search_repository
