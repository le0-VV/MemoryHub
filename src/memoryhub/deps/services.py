"""Service dependency injection for memoryhub.
...
from memoryhub.deps.repositories import (
    EntityRepositoryDep,
...
from memoryhub.services import EntityService, ProjectService
...
from memoryhub.sync import SyncService
