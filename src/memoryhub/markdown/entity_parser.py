...
from memoryhub.markdown.plugins import observation_plugin, relation_plugin
...
from memoryhub.utils import parse_tags
...
class EntityParser:
    ...
    async def parse_markdown_content(
        ...
        # See issue #452
        from memoryhub.file_utils import strip_bom
