"""Utility functions for memoryhub."""
...
def normalize_project_path(path: str) -> str:
    ...
    Args:
        path: Project path (e.g., "/app/data/memoryhub-llc" or "C:\\Users\\...")

    Returns:
        Normalized path (e.g., "/memoryhub-llc" or "C:\\Users\\...")
...
def setup_logging(
    ...
    if log_to_file:
        log_path = Path.home() / ".memoryhub" / "memoryhub.log"
