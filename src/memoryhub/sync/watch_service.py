...
from memoryhub.config import BasicMemoryConfig, WATCH_STATUS_JSON
from memoryhub.ignore_utils import load_gitignore_patterns, should_ignore_path
...
class WatchService:
    def __init__(
        ...
        self.status_path = Path.home() / ".memoryhub" / WATCH_STATUS_JSON
