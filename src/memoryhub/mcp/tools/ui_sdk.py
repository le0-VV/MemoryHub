...
from memoryhub.mcp.ui.sdk import MissingMCPUIServerError, build_embedded_ui_resource
...
async def search_notes_ui(
    ...
    try:
        resource = build_embedded_ui_resource(
            uri="ui://memoryhub/search-results/mcp-ui-sdk",
            html_filename="search-results-mcp-ui.html",
            render_data=render_data,
            preferred_frame_size=["100%", "540px"],
            metadata={"memoryhub.ui-variant": "mcp-ui-sdk"},
        )
...
async def read_note_ui(
    ...
    try:
        resource = build_embedded_ui_resource(
            uri="ui://memoryhub/note-preview/mcp-ui-sdk",
