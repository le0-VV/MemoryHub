...
from memoryhub.repository.search_repository import SearchRepository, SearchIndexRow
from memoryhub.schemas.memory import MemoryUrl, memory_url_path
...
class ContextService:
    ...
    async def find_related(
        ...
        # Use a SQLite recursive CTE that operates directly on entity and relation tables.
