...
from memoryhub.markdown import EntityMarkdown
from memoryhub.markdown.entity_parser import (
    EntityParser,
    _coerce_to_string,
    normalize_frontmatter_metadata,
)
from memoryhub.markdown.utils import entity_model_from_markdown, schema_to_markdown
from memoryhub.models import Entity as EntityModel
from memoryhub.models import Observation, Relation
from memoryhub.models.knowledge import Entity
from memoryhub.repository import ObservationRepository, RelationRepository
...
from memoryhub.schemas.base import Permalink
...
from memoryhub.services import BaseService, FileService
...
from memoryhub.utils import build_canonical_permalink
...
class EntityService(BaseService[EntityModel]):
    ...
    async def detect_file_path_conflicts(
        ...
        from memoryhub.utils import detect_potential_file_conflicts
    ...
    def _build_frontmatter_markdown(
        ...
        from memoryhub.markdown.schemas import EntityFrontmatter
