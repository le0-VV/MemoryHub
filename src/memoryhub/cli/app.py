...
from memoryhub.cli.container import CliContainer, set_container  # noqa: E402
from memoryhub.cli.promo import maybe_show_init_line  # noqa: E402
from memoryhub.config import init_cli_logging  # noqa: E402
...
def version_callback(value: bool) -> None:
    ...
    if value:  # pragma: no cover
        ...
        typer.echo(f"MemoryHub version: {memoryhub.__version__}")
        raise typer.Exit()


app = typer.Typer(name="memoryhub")
...
def app_callback(
    ...
    """MemoryHub - Local-first personal knowledge management."""
    ...
    if (
        ...
        from memoryhub.services.initialization import ensure_initialization
