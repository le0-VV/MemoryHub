"""Main CLI entry point for memoryhub."""  # pragma: no cover

import sys
import warnings

from memoryhub.cli.app import app  # pragma: no cover
...
if not _version_only_invocation(sys.argv[1:]):
    ...
    from memoryhub.cli.commands import (  # noqa: F401  # pragma: no cover
        db,
        doctor,
        import_chatgpt,
